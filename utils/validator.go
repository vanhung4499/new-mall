...
//@author: [piexlmax](https://github.com/piexlmax)
//@function: NotEmpty
//@description: Non-empty cannot have a value of 0 for its corresponding type
//@return: string
...
// @description: Regularity verification Verifies whether the input item satisfies the regular expression
// @param:  rule string
// @return: string
...
//@author: [piexlmax](https://github.com/piexlmax)
//@function: Le
//@description: Less than or equal to input parameter (<=) If it is string array Slice, it is length comparison. If it is int uint float, it is numerical comparison.
//@param: mark string
//@return: string
...
//@author: [piexlmax](https://github.com/piexlmax)
//@function: Ne
//@description: Not equal to the input parameter (!=) If it is a string array Slice, it is a length comparison. If it is an int uint float, it is a numerical comparison.
//@param: mark string
//@return: string
...
//@param: st interface{}, roleMap Rules(Input parameter instance, rule map)
//@return: err error
			...
			for _, v := range roleMap[tagVal.Name] {
				...
				case compareMap[strings.Split(v, "=")[0]]:
					if !compareVerify(val, v) {
						return errors.New(tagVal.Name + "The length or value is outside the legal range," + v)
					}
				}
			}
		}
...
//@description: Length and number verification method Automatic verification based on type
