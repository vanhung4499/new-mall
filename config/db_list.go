...
// The Embeded structure can be flattened to the previous layer, thus keeping the structure of the config file the same as before.
...
type GeneralDB struct {
	...
	LogMode      string `mapstructure:"log-mode" json:"log-mode" yaml:"log-mode"`                   // Whether to enable Gorm global logs
	...
	Singular     bool   `mapstructure:"singular" json:"singular" yaml:"singular"`                   //Whether to enable global disabling of pluralization, true means enabled
